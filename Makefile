...
install: 
	...
	@install -m 0644 vomsdir/cclcgvomsli01.in2p3.fr.1413.pem $(vomsdir_prefix)
	...
	@install -m 0644 vomsdir/vo.racf.bnl.gov.40260.pem $(vomsdir_prefix)
	...
	@install -m 0644 vomsdir/voms.fnal.gov.35501.pem $(vomsdir_prefix)
